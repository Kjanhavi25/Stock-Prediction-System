					...
					<div class="col-sm-12">
						<section class="row">
							<div class="col-lg-offset-3 col-md-12 col-lg-9">
								<div class="jumbotron">
									<h1 class="mb-4"><center>Check Prediction</center></h1>
									<div class="card mb-4">
										...
										<form class="form-horizontal" action="PredictionController" method="post">
											<fieldset>
												...
												<div class="form-group">
													<label class="col-12 control-label no-padding" for="name">Select Company</label>
													
													<div class="col-12 no-padding">
													<select  name="company" >
														   
                    <option value="Bajaj Electricals Ltd">Bajaj Electricals Ltd</option>
                    <option value="Idea Cellular Ltd">Idea Cellular Ltd</option>
