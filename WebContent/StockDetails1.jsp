					...
					<div class="col-sm-12">
						<section class="row">
							<div class="col-lg-offset-3 col-md-12 col-lg-9">
								<div class="jumbotron">
									<h1 class="mb-4"><center>Stock Details</center></h1>
									<div class="card mb-4">
											...
											<fieldset>
												...
												<div class="form-group">
													...
													<div class="col-12 no-padding">
														  	...
														  	<a href="StockDetails.jsp" class="btn btn-primary btn-md float-center">Bajaj Electricals Ltd</a>
														  	<br><br>
														  	<a href="StockDetails2.jsp" class="btn btn-primary btn-md float-center">Idea Cellular Ltd</a>
														  	<br><br>
														  	<a href="StockDetails3.jsp" class="btn btn-primary btn-md float-center">Infosys Ltd</a>
														  	<br><br>
														  	<a href="StockDetails4.jsp" class="btn btn-primary btn-md float-center">State bank of India</a>
														  	<br><br>
														  	<a href="StockDetails5.jsp" class="btn btn-primary btn-md float-center">TATA Steel</a>
              <br>
