		...
		<div class="row">
			<nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2 bg-faded sidebar-style-1">
				...
				<a href="#menu-toggle" class="btn btn-default" id="menu-toggle"><em class="fa fa-bars"></em></a>
					...
					<li class="nav-item"><a class="nav-link" href="StockDetails1.jsp"><em class="fa fa-bar-chart"></em>Stock Details</a></li>
			...
			<main class="col-xs-12 col-sm-8 offset-sm-4 col-lg-9 offset-lg-3 col-xl-10 offset-xl-2 pt-3 pl-4">
				<header class="page-header row justify-center">
					...
					<div class="dropdown user-dropdown col-md-6 col-lg-4 text-center text-md-right"><a id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						...
						<div>
							<h4><% response.setContentType("text/html");
					...
					<div class="col-sm-12">
						<section class="row">
							<div class="col-md-12 col-lg-12">
								 <img src="images/3.jpeg" height="750" width="1020">
