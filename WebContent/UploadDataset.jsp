	...
	<div class="container-fluid" id="wrapper">
		<div class="row">
			<nav
				...
				<h1 class="site-title">
					<a href="index.jsp"><em class="fa fa-rocket"></em>STOCK</a>
				</h1>
				...
				<ul class="nav nav-pills flex-column sidebar-nav">
					...
					<li class="nav-item"><a class="nav-link" href="ViewUsers.jsp"><em class="fa fa-bar-chart"></em>View Users</a></li>
					
                    <li class="nav-item"><a class="nav-link" href="UploadDataset.jsp"><em class="fa fa-bar-chart"></em>Upload Dataset</a></li>
						...
						<div class="col-lg-offset-3 col-md-12 col-lg-9">
							<div class="jumbotron">
								<h1 class="mb-4" style="color:#6365d2">
									<center>Upload Dataset</center>
								</h1>
								<div class="card mb-4">
									<div class="card-block">

										<form class="form-horizontal"
											action=UploadDatasetController method="post" enctype="multipart/form-data">
											<fieldset>
